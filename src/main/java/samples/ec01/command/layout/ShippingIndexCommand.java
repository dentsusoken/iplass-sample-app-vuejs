...
@CommandClass(
		name = "samples/ec01/layout/ShippingIndexCommand", 
		displayName = "配送先入力用レイアウトコマンド")
public class ShippingIndexCommand implements Command {

	private final String PRODUCT_CATEGORY_NAME = Product.CATEGORY + "." + Category.NAME;
